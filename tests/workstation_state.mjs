...
const activity = {
  bins: [
    {phase: 'choice', t_start_ms: 0, t_end_ms: 100, indices: [20, 4, 99], counts: [0, 3, 2], total_spikes: 5},
    {phase: 'feedback', t_start_ms: 500, t_end_ms: 700, indices: [4, 7], counts: [5, 1], total_spikes: 6},
  ],
};
