...
def test_http_only_enumerated_artifacts_and_no_mutation(dashboard):
    ...
    for path in ("/", "/observatory", "/app.js", "/style.css", "/player.css", "/player.mjs", "/player-state.mjs", "/workstation-view.js", "/workstation-state.mjs", "/workstation-audio.mjs", "/keyboard.wav", "/watch/run.json", "/watch/activity.json", "/snapshot.json", "/images/adaptive-1-1-input.png"):
